var isDrawerOpen = false,
    ...
    dawerProgress,
    isKorean=false,
    baseUrl = "https://github.com/VaishnaviVV/music-player",
    accentColorAr = [
        '#ff4b66',
        '#62ff6e',
        '#ffb762',
...
var songs, english = [

    {
        ...
        singer:"Alan Walker",
        duration:"03:05",
        url:"{{ url_for('static',filename='assets/End_Of_Time.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/End_Of_Time.mp3.jpg') }}"
    },

    {
        ...
        url:"{{ url_for('static',filename='assets/On_My_Way.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/On_My_Way.jpg') }}"
    },

    {
        ...
        singer:"Alan Walker",
        duration:"03:16",
        url:"{{ url_for('static',filename='assets/Lily.mp3') }}",
        url:"{{ url_for('static',filename='assets/Lily.jpg') }}"
    },

    {
        ...
        url:"{{ url_for('static',filename='assets/Alone_Part_II.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Alone_Part_II.jpg') }}"
    },

    {
        ...
        singer:"Alan Walker",
        duration:"03:11",
        url:"{{ url_for('static',filename='assets/Sing_Me_To_Sleep.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Sing_Me_To_Sleep.jpg') }}"
    },

    {
        ...
        singer:"Alan Walker",
        duration:"03:30",
        url:"{{ url_for('static',filename='assets/Ignite.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Sing_Me_To_Sleep.jpg') }}"
    },

    {
        ...
        singer:"Alan Walker",
        duration:"03:32",
        url:"{{ url_for('static',filename='assets/Faded.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Faded.jpg') }}"
    },

    {
        ...
        duration:"04:12",
        url:"{{ url_for('static',filename='assets/Keep_Holding_On.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Keep_Holding_On.jpg') }}"
    },

    {
        ...
        singer:"Demi Lovato",
        duration:"03:28",
        url:"{{ url_for('static',filename='assets/Give_Your_Heart_a_Break.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Give_Your_Heart_a_Break.jpg') }}"
    },

    {
        ...
        duration:"05:35",
        url:"{{ url_for('static',filename='assets/You_Are_Not_Alone.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/You_Are_Not_Alone.jpg') }}"
    },

    {
        ...
        singer:"Demi Lovato",
        duration:"03:11",
        url:"{{ url_for('static',filename='assets/Skyscraper.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Skyscraper.jpg') }}"
    },
...

    {
        ...
        singer:"Avril Lavigne",
        duration:"03:50",
        url:"{{ url_for('static',filename='assets/Wish_You_Were_Here.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Wish_You_Were_Here.jpg') }}"
    },

    {
        ...
        singer:"Demi Lovato",
        duration:"03:29",
        url:"{{ url_for('static',filename='assets/Heart_Attack.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Heart_Attack.jpg') }}"
    },

    {
        ...
        singer:"Alan Walker",
        duration:"02:45",
        url:"{{ url_for('static',filename='assets/Legends_Never_Die.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Legends_Never_Die.jpg') }}"
    },
...
var korean = [

    {
        ...
        singer:"BlackPink",
        duration:"03:13",
        url:"{{ url_for('static',filename='assets/Kill_This_Love.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Kill_This_Love.jpg') }}"
    },

    {
        ...
        duration:"04:12",
        url:"{{ url_for('static',filename='assets/Boy_With_Luv.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Boy_With_Luv.jpg') }}"
    },

    {
        ...
        singer:"BTS",
        duration:"04:02",
        url:"{{ url_for('static',filename='assets/Fake_Love.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Fake_Love.jpg') }}"
    },

    {
        ...
        singer:"BTS",
        duration:"06:03",
        url:"{{ url_for('static',filename='assets/Blood_Sweat_And_Tears.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Blood_Sweat_And_Tears.jpg') }}"
    },

    {
        ...
        singer:"Twice",
        duration:"03:38",
        url:"{{ url_for('static',filename='assets/FANCY.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/FANCY.jpg') }}"
    },

    {
        ...
        singer:"BTS",
        duration:"04:50",
        url:"{{ url_for('static',filename='assets/Not_Today.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Not_Today.jpg') }}"
    },

    {
        ...
        singer:"BlackPink",
        duration:"03:33",
        url:"{{ url_for('static',filename='assets/Ddu-Du_Ddu-Du.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Ddu-Du_Ddu-Du.jpg') }}"
    },

    {
        ...
        singer:"Twice",
        duration:"03:40",
        url:"{{ url_for('static',filename='assets/Feel_Special.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Feel_Special.jpg') }}"
    },
...

    {
        ...
        singer:"BTS",
        duration:"03:36",
        url:"{{ url_for('static',filename='assets/Save_ME.mp3') }}",
        albumArt:"{{ url_for('static',filename='img/Save_ME.jpg') }}"
    },
